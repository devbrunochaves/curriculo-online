...
const floatingTools = [
  ...
  { name: 'ChatGPT', icon: '/icons/tools/chatgpt.svg', x: '18%', y: '30%', size: 82, delay: 2.9, duration: 9.2 },
  { name: 'Magnific', icon: '/icons/tools/magnific.svg', x: '53%', y: '86%', size: 84, delay: 1.1, duration: 8.7 },
